...
<head>
    ...
    <link href="soft-ui/assets/css/nucleo-svg.css" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="soft-ui/assets/css/soft-ui-dashboard.css?v=1.0.5" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <script src="soft-ui/assets/js/plugins/chartjs.min.js"></script>
    <script>
    ...
    <script src="soft-ui/assets/js/soft-ui-dashboard.min.js?v=1.0.5"></script>
</body>
